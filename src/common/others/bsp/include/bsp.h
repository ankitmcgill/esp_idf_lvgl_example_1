...
// LCD SIZE
#define BSP_LCD_RESOLUTION_X    (800)
#define BSP_LCD_RESOLUTION_Y    (480)
...
#define BSP_LCD_GPIO_DATA0      (GPIO_NUM_1)    # R3
#define BSP_LCD_GPIO_DATA1      (GPIO_NUM_2)    # R4
#define BSP_LCD_GPIO_DATA2      (GPIO_NUM_42)   # R5
#define BSP_LCD_GPIO_DATA3      (GPIO_NUM_41)   # R6
#define BSP_LCD_GPIO_DATA4      (GPIO_NUM_40)   # R7
...
#define BSP_LCD_GPIO_DATA11     (GPIO_NUM_14)   # B3
#define BSP_LCD_GPIO_DATA12     (GPIO_NUM_38)   # B4
#define BSP_LCD_GPIO_DATA13     (GPIO_NUM_18)   # B5
#define BSP_LCD_GPIO_DATA14     (GPIO_NUM_17)   # B6
#define BSP_LCD_GPIO_DATA15     (GPIO_NUM_10)   # B7
